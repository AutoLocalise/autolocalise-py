...
class TestCacheThreadSafety:
    ...
    def test_global_cache_singleton(self):
        ...
        translator = Translator(api_key="test", source_locale="en", target_locale="fr", shared_cache=True)
...
class TestSharedCache:
    ...
    def test_shared_cache_between_instances(self):
        ...
        t1 = Translator(api_key="test-key-1", source_locale="en", target_locale="fr", shared_cache=True)
        t2 = Translator(api_key="test-key-2", source_locale="en", target_locale="fr", shared_cache=True)
    ...
    def test_independent_cache_instances(self):
        ...
        t1 = Translator(api_key="test-key-1", source_locale="en", target_locale="fr", shared_cache=False)
        t2 = Translator(api_key="test-key-2", source_locale="en", target_locale="fr", shared_cache=False)
    ...
    def test_mixed_cache_modes(self):
        ...
        shared1 = Translator(api_key="shared-1", source_locale="en", target_locale="fr", shared_cache=True)
        shared2 = Translator(api_key="shared-2", source_locale="en", target_locale="fr", shared_cache=True)
        independent = Translator(api_key="independent", source_locale="en", target_locale="fr", shared_cache=False)
    ...
    def test_concurrent_shared_cache_access(self):
        ...
        def worker(thread_id):
            translator = Translator(api_key=f"key-{thread_id}", source_locale="en", target_locale="fr", shared_cache=True)
        ...
        final_translator = Translator(api_key="final", source_locale="en", target_locale="fr", shared_cache=True)
    ...
    def test_shared_cache_with_real_translations(self, mock_post):
        ...
        mock_post.side_effect = [
            ...
            Mock(status_code=200, json=lambda: {"translations": {"69609650": "Bonjour"}}),  # Hash of "Hello"
...
class TestCacheOperations:
    ...
    def test_cache_operations(self):
        ...
        translator = Translator(api_key="test-key", source_locale="en", target_locale="fr", shared_cache=False)
    ...
    def test_clear_cache_behavior(self):
        ...
        t1 = Translator(api_key="key-1", source_locale="en", target_locale="fr", shared_cache=True)
        t2 = Translator(api_key="key-2", source_locale="en", target_locale="es", shared_cache=True)
